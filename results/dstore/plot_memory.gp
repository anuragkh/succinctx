...
plot 'memory.txt' every ::0 using 1:3:xtic(2) title "" lc rgb "#A00000" lw 0.1 with boxes,\
    'memory.txt' every ::1 using 1:3:xtic(2) title "" lc rgb "#00A000" lw 0.1 with boxes,\
    'memory.txt' every ::2 using 1:3:xtic(2) title "" lc rgb "#5060D0" lw 0.1 with boxes
